...
Source files within `main/` are shared and identical with `right_screen/main/`. Functional differences between screens are enabled at compile-time via `CONFIG_LEFT_SIDE_DISPLAY`.
