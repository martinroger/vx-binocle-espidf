...
| `interface_board` | `binocan` | `0.2.0` (`c6e8c1d`) | `v0.2.0` *(git: martinroger/binocan)* |
...
| `left_screen` | `binocan` | `0.2.0` (`c6e8c1d`) | `v0.2.0` *(git: martinroger/binocan)* |
...
| `right_screen` | `binocan` | `0.2.0` (`c6e8c1d`) | `v0.2.0` *(git: martinroger/binocan)* |
...
| `factory apps/ITF factory app` | `binocan` | `0.2.0` (`c6e8c1d`) | `v0.2.0` *(git: martinroger/binocan)* |
