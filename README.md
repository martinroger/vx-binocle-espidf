...
| `interface_board` | `binocan` | `0.1.0` | `~0.1.0` *(git: martinroger/binocan)* |
...
| `left_screen` | `binocan` | `0.1.0` | `~0.1.0` *(git: martinroger/binocan)* |
...
| `right_screen` | `binocan` | `0.1.0` | `~0.1.0` *(git: martinroger/binocan)* |
...
| `factory apps/ITF factory app` | `binocan` | `0.1.0` | `~0.1.0` *(git: martinroger/binocan)* |
