#pragma once
#define COEFF_DUTY_TO_COOLANT_DEGC_M (double)(0.7173712271)
#define COEFF_DUTY_TO_COOLANT_DEGC_P (double)(64.37792284)
#define COEFF_COOLANT_DEGC_TO_DUTY_M (double)(1 / COEFF_DUTY_TO_COOLANT_DEGC_M)
#define COEFF_COOLANT_DEGC_TO_DUTY_P (double)(-COEFF_DUTY_TO_COOLANT_DEGC_P / COEFF_DUTY_TO_COOLANT_DEGC_M)
