 ...
 * - Start as open AP named LDB-<MAC>
 * - Start mDNS as hostname "left-display"
...
{
	mdns_init();
	mdns_hostname_set("left-display");
	mdns_instance_name_set("Left Display Factory");
}
...
static void start_ap_mode(void)
{
	...
	char ssid[32];
	snprintf(ssid, sizeof(ssid), "LDB-%02X%02X%02X", mac[3], mac[4], mac[5]);
