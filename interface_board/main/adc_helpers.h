...
static i2c_dev_t adc_slave;                 // I2C device object for the ADC
static uint32_t conversion_interval_ms = 1; // Minimum interval between ADC conversions. Recalculated during initialisation.

/// @brief Hardware initialisation function
/// @return ESP_OK if all went right, ESP_FAIL otherwise
inline esp_err_t initialize_ADC()
{
...
inline int16_t adc_measure_channel_raw(uint8_t channel_num)
{
